...
@section('halaman', 'Tambah Data Wisata')
...
{{--            </div>--}}
{{--        @endif--}}
        <form action="{{ route('wisata.simpan')  }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-lg-7">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control @error('nama_wisata') is-invalid @enderror" id="nama_wisata" name="nama_wisata" value="{{ old('nama_wisata') }}">
                                @error('nama_wisata')
                            ...
                            <div class="col-sm-9">
                                <div class="form-check">
                                    <input class="form-check-input @error('destinasi_unggulan') is-invalid @enderror"
                                        ...
                                        {{ old('destinasi_unggulan') ? 'checked' : '' }}>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                ...
                                <textarea class="form-control @error('deskripsi') is-invalid @enderror d-none" id="deskripsi" name="deskripsi" rows="3">{{ old('deskripsi') }}</textarea>
                                @error('deskripsi')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control @error('harga_tiket') is-invalid @enderror" id="harga_tiket" name="harga_tiket" value="{{ old('harga_tiket') }}">
                                @error('harga_tiket')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control @error('biaya_parkir') is-invalid @enderror" id="biaya_parkir" name="biaya_parkir" value="{{ old('biaya_parkir') }}">
                                @error('biaya_parkir')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control @error('jam_operasional') is-invalid @enderror" id="jam_operasional" name="jam_operasional" value="{{ old('jam_operasional') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <textarea class="form-control @error('transportasi') is-invalid @enderror" id="transportasi" name="transportasi" rows="3">{{ old('transportasi') }}</textarea>
                                @error('transportasi')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <textarea class="form-control @error('peraturan') is-invalid @enderror" id="peraturan" name="peraturan" rows="3">{{ old('peraturan') }}</textarea>
                                @error('peraturan')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                    ...
                    <div class="col-lg-5">
                        ...
                        <div class="form-floating mb-3">
                            <input type="number" class="form-control @error('latitude') is-invalid @enderror" id="latitude" placeholder="masukan latitude" name="latitude" value="{{ old('latitude') }}" step="any" oninput="updateMap()">
                        ...
                        <div class="form-floating">
                            <input type="number" class="form-control @error('longitude') is-invalid @enderror" id="longitude" placeholder="masukan longitude" name="longitude" value="{{ old('longitude') }}" step="any" oninput="updateMap()">
...
@push('script')
    <script type="text/javascript">
        let map;
        let marker;
        initMap(2.253020086054838, 98.74814367679366, "Kab. Humbang Hasundutan");
